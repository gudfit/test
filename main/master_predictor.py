        ...
        if not use_classifier or prediction_type == 'regressor_fallback':
             ...
             try:
                ...
                if pd.isna(sched_dep_target):
                    return {'prediction_type': final_prediction_type, 'value': None, 'status': 'error', 'message': 'Target flight schedule time is invalid.'}
                ...
                # Assume self.config.CHAIN_DELAY_THRESHOLDS is a sorted list of thresholds.
                ...
                sigma = 15.0  # This parameter controls the "spread" of the soft distribution.
                scores = [np.exp(-((predicted_delay_minutes - center)**2) / (2 * sigma**2)) 
