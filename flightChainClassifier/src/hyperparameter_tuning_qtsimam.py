...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Hyperparameter Tuning for QTSimAM CNN-LSTM Model")
    ...
    print(f"Hyperparameter Tuning (QTSimAM): Using balanced training data? {config.BALANCED}")
